        ...
        <>
            <Layout>
                ...
                <BannerContainer style={{ marginTop: '15px', borderRadius: '15px' }}>
                    ...
                    <BannerContent>
                        <Typography variant="h4">Las muertes ocurridas en los tres dias que duraron los hechos más violentos de la huelga.</Typography>
                ...
                <BannerContainer style={{ marginTop: '15px', borderRadius: '15px' }}>
                    ...
                    <BannerContent>
                        ...
                        <BannerDescription variant="h6" style={{ marginTop: '10px' }}>
                        La huelga de cananea en 1906 fue un suceso bastante manipulado por las autoridades 
                        y Greene, pero particular mente la cuenta de muertos, pues es solo gracias a testigos 
                        presenciales y algunos periódicos de la época que registraron principalmente la muerte 
                        de extranjeros, es que podemos tener un estimado de muertos por el enfrentamiento de esa t
                        arde del 2 de junio.
                        </BannerDescription>
                    </BannerContent>
                </BannerContainer>
                ...
                <BannerContainer style={{ marginTop: '15px', borderRadius: '15px' }}>
                    ...
                    <BannerContent>
                        ...
                        <BannerDescription variant="h6" style={{ marginTop: '10px' }}>
                        Los trabajadores organizaron y realizaron una manifestación, que inicio con 
                        1500 personas. Con tres cartelones con el mensaje de cinco pesos ocho horas, 
                        en el camino se unieron más a la manifestación en buena vista fueron 500, en 
                        la concentradora 200 y en la fundición alrededor de 1000.
                        Cerca de la demostración, Greene y 30 yanquis armados, vigilaban desde automóviles 
                        el desarrollo del movimiento obrero. La empresa imperialista se preparaba para la 
                        represión, los empleados de confianza y pistoleros organizados fueron dispuestos 
                        para la lucha anti obrera.
                        </BannerDescription>
                    </BannerContent>
                </BannerContainer>
